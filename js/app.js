...
import { renderPractice } from './pages/practice.js?v=3.50';
...
import { renderPaymentSuccess, renderPaymentCancel } from './pages/payment-status.js';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // 6. Initialize Stripe Checkout (loads in demo mode if no key configured)
  StripeCheckout.init();

  // 7. Expose Database globally for Stripe checkout module
